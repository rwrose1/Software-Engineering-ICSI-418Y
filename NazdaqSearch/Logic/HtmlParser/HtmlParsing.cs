...
namespace NazdaqSearch.Logic.HtmlParser
{
	...
	public class HtmlParsing
	{
		...
		public static List<NazdaqData> getData() 
		{
			List<NazdaqData> toBeReturned = new List<NazdaqData>();
		...
		public static List<NazdaqData> parseString(List<HtmlNode> cleanedNodes, TitleAndLink titleLink) {
			...
			foreach (HtmlNode item in cleanedNodes) {
				...
				foreach(String paragraph in paragraphs) {
					...
					NazdaqData data = new NazdaqData();
		...
		public static void consoleDisplay(List<NazdaqData> fullData) {
			foreach(NazdaqData item in fullData) {
